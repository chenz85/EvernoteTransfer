...
// api: oauth
type ApiReqOauth struct {
	Svr                  string   `protobuf:"bytes,1,opt,name=svr,proto3" json:"svr,omitempty"`
...
func (m *ApiReqOauth) Reset()         { *m = ApiReqOauth{} }
func (m *ApiReqOauth) String() string { return proto.CompactTextString(m) }
func (*ApiReqOauth) ProtoMessage()    {}
func (*ApiReqOauth) Descriptor() ([]byte, []int) {
	return fileDescriptor_msg_7812e73bc9979691, []int{0}
}
func (m *ApiReqOauth) XXX_Unmarshal(b []byte) error {
	return m.Unmarshal(b)
}
func (m *ApiReqOauth) XXX_Marshal(b []byte, deterministic bool) ([]byte, error) {
	if deterministic {
		return xxx_messageInfo_ApiReqOauth.Marshal(b, m, deterministic)
	} else {
		b = b[:cap(b)]
		n, err := m.MarshalTo(b)
		if err != nil {
...
func (dst *ApiReqOauth) XXX_Merge(src proto.Message) {
	xxx_messageInfo_ApiReqOauth.Merge(dst, src)
}
func (m *ApiReqOauth) XXX_Size() int {
	return m.Size()
}
func (m *ApiReqOauth) XXX_DiscardUnknown() {
	xxx_messageInfo_ApiReqOauth.DiscardUnknown(m)
}

var xxx_messageInfo_ApiReqOauth proto.InternalMessageInfo

func (m *ApiReqOauth) GetSvr() string {
	if m != nil {
		return m.Svr
	}
	return ""
...
func (m *ApiReqOauth) GetSide() string {
	if m != nil {
		return m.Side
	}
	return ""
...
func (*ApiRespOauth) Descriptor() ([]byte, []int) {
	return fileDescriptor_msg_7812e73bc9979691, []int{1}
}
...
func (*OauthInfo) Descriptor() ([]byte, []int) {
	return fileDescriptor_msg_7812e73bc9979691, []int{2}
}
...
func (m *ApiReqOauth) MarshalTo(dAtA []byte) (int, error) {
	var i int
	_ = i
	var l int
	_ = l
	if len(m.Svr) > 0 {
		dAtA[i] = 0xa
		i++
		i = encodeVarintMsg(dAtA, i, uint64(len(m.Svr)))
		i += copy(dAtA[i:], m.Svr)
	}
	if len(m.Side) > 0 {
		dAtA[i] = 0x12
		i++
		i = encodeVarintMsg(dAtA, i, uint64(len(m.Side)))
		i += copy(dAtA[i:], m.Side)
	}
...
func (m *ApiReqOauth) Unmarshal(dAtA []byte) error {
	l := len(dAtA)
	iNdEx := 0
	for iNdEx < l {
		preIndex := iNdEx
		...
		if wireType == 4 {
			return fmt.Errorf("proto: api_req_oauth: wiretype end group for non-group")
		}
		if fieldNum <= 0 {
			return fmt.Errorf("proto: api_req_oauth: illegal tag %d (wire type %d)", fieldNum, wire)
		}
		switch fieldNum {
		case 1:
			if wireType != 2 {
...
func init() { proto.RegisterFile("service/msg.proto", fileDescriptor_msg_7812e73bc9979691) }

var fileDescriptor_msg_7812e73bc9979691 = []byte{
	// 288 bytes of a gzipped FileDescriptorProto
	,
}
